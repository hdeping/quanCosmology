...
![diagramNeural](figures/diagramNeural.png)
...
![percetron](figures/percetron.png)
...
![diagramBack](figures/diagramBack.png)
...
![rnn1](figures/20180604_154108_rnn4_unfold.png)

​	为了更加清楚的表示RNN的结构，我们可以将输入层，隐藏层和输出层分别展开。于是可以得到如下更加详细的示意图。

![rnn1](figures/20180604_152939_rnn3.png)
...
​	对于这样的指数形式的解，通常我们可以用递推公式去表示。有了递推公式，我们很容易用计算机去实现解的计算。
...
http://facstaff.susqu.edu/brakke/constructions/big-gon.htm# 那些年的日志
